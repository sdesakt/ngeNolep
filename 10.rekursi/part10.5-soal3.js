...
Function akan mengembalikan/me-return berapa kali seorang customer memesan/
mengambil makanan dalam waktu yang diberikan. Wajib menggunakan rekursif.
...
function makanTerusRekursif(waktu) {
  ...
  //!kalau waktu 15 ke bawah, diitung 1
  if (waktu <= 15) {
    return 1;
  } else {
    //!selain itu, diitung 1 tapi rekursif ngulang dengan parameter yg dikurangi 15 (1 putaran)
